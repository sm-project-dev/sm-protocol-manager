...
class Converter extends AbstConverter {
  ...
  generationCommand(generationInfo) {
    ...
    cmdList.forEach(cmdInfo => {
      ...
      commandInfo.data = frameInfo;

      // 명령 후 요청까지의 대기 시간
      commandInfo.commandExecutionTimeoutMs = 1000 * 2;
      // 명령 전 대기 시간
      commandInfo.delayExecutionTimeoutMs = _.isNumber(cmdInfo.timeout)
        ? cmdInfo.timeout
        : undefined;
      returnValue.push(commandInfo);
    });
    return returnValue;
  }
